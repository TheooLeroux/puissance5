...
<body>
  ...
  <header>
    ...
    <div class="flexNav">
      <div>
        <p><img class="logo02"
            src="https://media.discordapp.net/attachments/301039123160891402/1028264022467956766/LOGO.png" alt=""></p>
      </div>
      <div>
        <nav>
  ...
  <div class="equipe">
    <a href="https://www.youtube.com/watch?v=pyS3vmnWTyU">
      <div><img src="assets/Image/marco.jpg" alt="Privé"><br> <br> Marko <br> <br>
        <p>Game Developer</p><br><img class="nix" src="assets/Image/sout.png" alt="sout">
      </div>
    </a>
    ...
    <a href="https://www.youtube.com/watch?v=EZEfN5z8Mlg">
      <div class="hamza"><img src="assets/Image/hamza.png" alt="Privé"><br> <br> Hamza <br> <br>
        <p>Bugger</p><br><img class="nix" src="assets/Image/sout.png" alt="sout">
      </div>
    </a>
  </div>
